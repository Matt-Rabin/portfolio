...
# ─── METADATA ──────────────────────────────────────────
title: "Flexor"
subtitle: "Low-Cost Modular Finger Prosthetic"
...
tags: ["Spring 2022", "Individual Project", "Biomechanics", "Advisor: Dr. Akkus"]

# ─── IMAGES ────────────────────────────────────────────
# Filename only — put files in src/assets/images/your-project-name/
hero: "flexorHERO@2x.webp"
logo: "flexorLOGO.svg"

# Images for each section — add as many as needed
concept_images: [FlexInitialModel@2x.webp, FlexInitialRender@2x.webp, Flexsketch@2x.webp]
results_images: [FlexMiddleRender@2x.webp, FlexTipRender@2x.webp, FlexBaseRender@2x.webp, FlexFinalPhoto1@2x.webp, FlexFinalPhoto2@2x.webp, FlexFullRender@2x.webp, FlexHandPhoto@2x.webp]
appendix_images: []
...
Technical details, specs, process notes, diagrams.
Anything that's too deep for the main case study
but useful for technical reviewers.
