...
const $$Admin = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (config.routeSlug === "mattslist") {
    try {
      adminUser = await getSaleAdminUser(Astro2);
